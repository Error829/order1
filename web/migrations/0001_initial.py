# Generated by Django 3.2 on 2024-03-07 14:33
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('charge_type', models.IntegerField(choices=[(3, '创建订单'), (5, '撤单'), (2, '扣款'), (1, '充值'), (4, '删除订单')], verbose_name='交易类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.IntegerField(choices=[(4, '失败'), (2, '正在执行'), (3, '完成'), (1, '待执行'), (5, '无')], default=5, verbose_name='状态')),
